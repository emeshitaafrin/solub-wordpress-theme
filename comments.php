...
if (comments_open()) :
    ...
    <div id="comments" class="contact-form-box mb-50">
        ...
        $fields = array(
            'author' => '<div class="row"><div class="col-xl-6"><div class="postbox-details-input-box"><div class="postbox-details-input mb-20"><input type="text" name="author" id="author" placeholder="' . esc_attr__('Your name', 'exdos') . '" value="' . esc_attr($commenter['comment_author']) . '" ' . ($req ? 'required' : '') . '>
            </div></div></div>',
            ...
            'url' => '<div class="col-xl-12"><div class="postbox-details-input-box"><div class="postbox-details-input mb-20"><input type="text" name="url" id="url" placeholder="' . esc_attr__('Website', 'exdos') . '" value="' . esc_attr($commenter['comment_author_url']) . '">
         </div></div></div></div>',
        );
        ...
        $defaults = [
            'fields'             => $fields,
            'comment_field' => '<div class="col-xl-12 ' . $cl . '"><div class="postbox-details-input-box"><div class="postbox-details-input mb-20">
            ...
            'submit_button' => '<div class="col-12"> <div class="postbox-details-input-box">
                                    <button type="submit" class="tp-btn btn-text-flip d-inline-block">
                                        <span data-text="' . esc_html__('Post Comment', 'exdos') . '">' . esc_html__('Post Comment', 'exdos') . '</span>
                                    </button>
                                </div></div>',
